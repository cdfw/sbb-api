    ...
    MatrixDetailsComponent.prototype.customFilterPredicate = function () {
        ...
        var myFilterPredicate = function (data, filter) {
            ...
            if (_this.globalFilter) {
                ...
                var updateInd = data.updateInd.toString().trim().toLowerCase().indexOf(_this.globalFilter.toString().toLowerCase()) !== -1;
                globalMatch = taskIdFound_1 || serviceNameFound_1 || programFound_1 || subProgramFound_1 || taskCategoryFound_1 || taskNameFound_1 || statusFound_1 || inputFound_1 || countFound_1 || fbReceivedFound_1 || taskDescFound || sgFound || toBeEnteredFound_1 || updateInd;
            }
            if (!globalMatch) {
                return;
            }
            ...
            var updateIndFound = data.updateInd.toString().trim().toLowerCase().indexOf(searchString.updateInd.toString().toLowerCase()) !== -1;
