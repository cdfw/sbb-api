...
var AuthenticationService = /** @class */ (function () {
    ...
    function AuthenticationService(http, snackBar) {
        ...
        this.API_URL = "http://cdfw-alb-prod-775994205.us-west-1.elb.amazonaws.com:9301/";
    }
...
/* harmony import */ var _service_mat_snack_bar_mat_snack_bar_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./service/mat-snack-bar/mat-snack-bar.component */ "./src/app/service/mat-snack-bar/mat-snack-bar.component.ts");
/* harmony import */ var _services_http_interceptor__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./_services/http.interceptor */ "./src/app/_services/http.interceptor.ts");
/* harmony import */ var _login_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./login/login-form/login-form.component */ "./src/app/login/login-form/login-form.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _service_mat_snack_bar_mat_snack_bar_component__WEBPACK_IMPORTED_MODULE_21__["MatSnackBarComponent"],
                _login_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_23__["ResestPasswordDialog"]
            ],
            imports: [
            ...
            providers: [{
                    ...
                    useClass: _services_error_interceptor__WEBPACK_IMPORTED_MODULE_20__["HttpErrorInterceptor"],
                    multi: true,
                },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_16__["HTTP_INTERCEPTORS"],
                    useClass: _services_http_interceptor__WEBPACK_IMPORTED_MODULE_22__["AuthInterceptor"],
                    multi: true,
                },
                _services_authentication_service__WEBPACK_IMPORTED_MODULE_15__["AuthenticationService"], _services__WEBPACK_IMPORTED_MODULE_18__["UserService"], _service_mat_snack_bar_mat_snack_bar_component__WEBPACK_IMPORTED_MODULE_21__["MatSnackBarComponent"]],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]],
            entryComponents: [_service_inputs_inputs_component__WEBPACK_IMPORTED_MODULE_14__["InputsComponent"], _login_login_form_login_form_component__WEBPACK_IMPORTED_MODULE_23__["ResestPasswordDialog"]]
        })
    ], AppModule);
    return AppModule;
}());
...
/*!**********************************************************!*\
  !*** ./src/app/login/login-form/login-form.component.ts ***!
  \**********************************************************/
/*! exports provided: LoginFormComponent, ResestPasswordDialog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var InputsComponent = /** @class */ (function () {
    function InputsComponent(serviceMatrix, dialogRef, userService, data, router, snackBar) {
        ...
        this.inputDisplayedColumns = ["value", "name", "status", "approverName"];
    ...
    InputsComponent.prototype.approveResponse = function () {
        ...
        var _self = this;
        this.serviceMatrix.selectInput(this.selectedRegionObject.regionId, this.data.taskId, this.selectedRow.id, this.userService.userId).subscribe(function (data) {
...
var MatrixDetailsComponent = /** @class */ (function () {
    ...
    MatrixDetailsComponent.prototype.showTask = function (row) {
        ...
        var tasks = this.dataSource.data.filter(function (e) { return e['subProgram'] == row.subProgram; });
        this.serviceMatrix.filterStore.selectedSubProgTasks = [];
        if (tasks.length > 1) {
    ...
    MatrixDetailsComponent.prototype.storeFilterValues = function (pageIndex) {
